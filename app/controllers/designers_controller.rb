class DesignersController < ApplicationController
  ...
  private
    ...
    def designer_params
      params.require(:designer).permit(:first_name, :last_name, :email, :phone_number, :company_name, :company_website, :profile_pic, :design_image, :location, :user_id, :remove_profile_pic, :remove_design_image, :about, :designer_id, :company_slogan, :designer, pictures:[])
    end
end
